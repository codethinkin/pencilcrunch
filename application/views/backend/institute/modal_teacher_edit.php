	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                    <?php echo form_open(base_url() . 'institute/teacher/do_update/'.$row['teacher_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <div>
                                            ...
                                            <a href="#" class="btn btn-orange fileinput-exists" data-dismiss="fileinput">Remove</a>
																		...
																		<input type="hidden" class="form-control" name="institute" value="<?php echo $row['institute'];?>"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="name" value="<?php echo $row['name'];?>"/>
														...
														<div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('profession');?></label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="" name="scale" value="<?php echo $row['scale'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="phone" value="<?php echo $row['phone'];?>"/>
														...
														<div class="form-group">
																...
																<div class="col-sm-5">
<input type="text" class="form-control" name="movi" value="<?php echo $row['movi'];?>" >
