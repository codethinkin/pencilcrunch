		...
		<div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                    	<?php
											$count = 1;
											$this->db->select('class_id, name, name_numeric, teacher_id, schedule');
											$this->db->from('class');
                        ...
                        <tr>
                            <td><?php echo $count++;?></td>
														...
														<td><?php echo $this->crud_model->get_towns_name_by_id('schedule',$row['schedule']);?></td>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    <!-- DELETION LINK -->
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>institute/classes/delete/<?php echo $row['class_id'];?>');">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url() . 'institute/classes/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
														...
														<div class="form-group">
																 ...
																 <div class="col-sm-5">
																		 <select name="teacher_id" class="form-control" style="width:100%;">
																			 <?php
										 $teachers= $this->db->get_where('teacher', array('institute'=> $Idint) )->result_array();
