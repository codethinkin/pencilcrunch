		...
		<div class="tabs-vertical-env">
			...
			?>
				<li class="<?php if ($row['class_id'] == $class_id) echo 'active';?>">
					<a href="<?php echo base_url();?>institute/section/<?php echo $row['class_id'];?>">
					...
					<table class="table table-bordered responsive">
						<thead>
							<tr>
								...
								<th><?php echo get_phrase('curse');?></th>
						...
						<?php
							$count    = 1;
							$sections = $this->db->get_where('section' , array('class_id' => $class_id, 'institute'=> $Idint))->result_array();
						...
						?>
							<tr>
								...
								<td>
									<?php if ($row['grade'] != '')
											echo $this->db->get_where('courses' , array('id' => $row['grade']))->row()->description;
										?>
								</td>
								<td>
								...
								<td>
									<div class="btn-group">
		                                ...
		                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
		                                    ...
		                                    <!-- DELETION LINK -->
		                                    <li>
		                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>institute/sections/delete/<?php echo $row['section_id'];?>');">
