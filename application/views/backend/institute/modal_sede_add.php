		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo get_phrase('add_sede');?>
            	</div>
            </div>
			<div class="panel-body">

                <?php echo form_open(base_url() . 'institute/sede/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
  							<input type="hidden" class="form-control" name="institute" value="<?php echo $Idint; ?> ">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <select name="gender_sede" class="form-control">
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info"><?php echo get_phrase('add_sede');?></button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>
