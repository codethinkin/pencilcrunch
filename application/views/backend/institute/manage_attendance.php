<hr />
	<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered">
		...
		<tbody>
        	<form method="post" action="<?php echo base_url();?>institute/attendance_selector" class="form">
            	<tr class="gradeA">
                    <td>
...
<form method="post"
    action="<?php echo base_url();?>institute/manage_attendance/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id;?>">
        <div class="col-sm-offset-3 col-md-6">
            <table  class="table table-bordered">
        		<thead>
        			<tr class="gradeA">
