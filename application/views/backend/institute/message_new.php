...
<div class="mail-compose">
    ...
    <?php echo form_open(base_url() . 'institute/message/send_new/', array('class' => 'form', 'enctype' => 'multipart/form-data')); ?>
    ...
    <div class="form-group">
        ...
        <select class="form-control select2" name="reciever" required>
            ...
            <optgroup label="<?php echo get_phrase('student'); ?>">
                <?php
                $students= $this->db->get_where('student', array('institute'=> $Idint) )->result_array();
