    ...
    <ul id="main-menu" class="">
        ...
        ?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'sede') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>admin/sede">
        ...
        ?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'list_student') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>admin/list_student">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('list_student'); ?></span>
                    </a>
                </li>
...
-->
        ...
        <li class="<?php if ($page_name == 'dormitory') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>admin/classroom">
