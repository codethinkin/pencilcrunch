...
<?php echo form_open(base_url() . 'admin/student/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
		...
		<div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
							...
							<div class="form-group">
							<label for="field-2" class="col-sm-3 control-label">Cumpleaños</label>
							...
							<div class="form-group">
							<label for="field-2" class="col-sm-3 control-label">Número Identificación</label>
							...
							<div class="form-group">
							<label for="field-2" class="col-sm-3 control-label">Tipo RH</label>
