			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'admin/parent/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
								...
								<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('student');?></label>
												<div class="col-sm-5">
														<select name="student" class="form-control" id="student_selector_holder">
																<option value=""><?php echo get_phrase('select');?></option>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="relationship" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" >
						</div>
					</div>
